      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h2>Contact</h2>
            <p>"Connections ignite creativity. Let's shape extraordinary experiences together. Reach out and let our journey begin! Whether it's a new project, collaboration, or a simple exchange of ideas, I'm eagerly looking forward to hearing from you. Let's make our mark in the world of possibilities!"</p>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row justify-content-center mt-4">
          ...
          <div class="col-lg-9">
            <form action="{{ asset('assets/forms/contact.php') }}" method="post" role="form" class="php-email-form">
              <div class="row">
